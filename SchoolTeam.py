...
class Application:
    ...
    def __init__(self, master):
        ...
        def rg():
            ...
            self.newbutt = Button(self.reg, text = 'BACK', font = ('tr 15 bold'), command = lambda:gohome_rg())
            ...
            self.sname = Label(self.reg, text = 'Enter the second name: ', font = ('tr 12 bold'))
            self.sname.place(x = 50, y = 200)

            self.age = Label(self.reg, text = 'Please fill in the age: ', font = ('tr 12 bold'))
            self.age.place(x = 50, y = 275)

            self.position = Label(self.reg, text = 'Please fill in the position:   ', font = ('tr 12 bold'))
            ...
            self.fname_ent = Entry(self.reg, width = 20, font = ('tr 15'))
            self.fname_ent.place(x = 50, y = 160)

            self.sname_ent = Entry(self.reg, width = 20, font = ('tr 15'))
            self.sname_ent.place(x = 50, y = 235)

            self.age_ent = Entry(self.reg, width = 20, font = ('tr 15'))
            self.age_ent.place(x = 50, y = 310)

            self.position_ent = Entry(self.reg, width = 20, font = ('tr 15'))
            self.position_ent.place(x = 50, y = 385)

            self.shirt_ent = Entry(self.reg, width = 20, font = ('tr 15'))
            self.shirt_ent.place(x = 50, y = 460)

            self.attrib_ent = Entry(self.reg, width = 20, font = ('tr 15'))
            self.attrib_ent.place(x = 50, y = 535)

            self.submit = Button(self.reg, text = 'Submit', font = ('tr 20 bold'), command = lambda: get_values())
        ...
        def lk():
            ...
            self.somebutt = Button(self.look, text = 'BACK', font = ('tr 15 bold'), command = lambda: gohome_lk())
            ...
            def searching(given_val):
            	if given_val == 'fnames':
            		...
            		self.labeler = Label(self.look, text = 'Please fill in the players second name: ', font = ('tr 23 bold'))
            		self.labeler.place(x=400,y=110)
            		...
            		self.labeler = Label(self.look, text = 'Please fill in the players shirt number: ', font = ('tr 23 bold'))
            		self.labeler.place(x=400,y=110)
            		...
            		self.labeler = Label(self.look, text = 'Please fill in the players age(s): ', font = ('tr 23 bold'))
            		self.labeler.place(x=400,y=110)
            		...
            		self.labeler = Label(self.look, text = 'Please fill in the players position(s): ', font = ('tr 23 bold'))
            		self.labeler.place(x=400,y=110)
            ...
            self.label = Label(self.look, text = 'Look for an existing player', font = ('tr 17 bold'))

            self.label.place(x=50, y=50)

            self.label_again = Label(self.look, text = 'How do you want to search?', font = ('tr 15 bold'))
            self.label_again.place(x=50,y=100)

            self.butt = Button(self.look, text = 'First Name', font = ('tr 15 bold'), command = lambda:searching('fnames'))
            self.butt.config(width=10)
            self.butt.place(x = 100, y = 150)

            self.butt2 = Button(self.look, text = 'Second Name', font = ('tr 15 bold'), command = lambda:searching('snames'))

            self.butt2.config(width=10)
            self.butt2.place(x = 100, y = 220)

            self.butt3 = Button(self.look, text = 'Shirt Number', font = ('tr 15 bold'), command = lambda:searching('shirtnums'))

            self.butt3.config(width=10)
            self.butt3.place(x = 100, y = 290)

            self.butt4 = Button(self.look, text = 'Age', font = ('tr 15 bold'), command = lambda:searching('ages'))
            self.butt4.config(width = 10)
            self.butt4.place(x = 100, y = 360)

            self.butt5 = Button(self.look, text = 'Position', font = ('tr 15 bold'), command = lambda:searching('positions'))
            self.butt5.config(width = 10)
            self.butt5.place(x = 100, y = 430)

            self.butt6 = Button(self.look, text = 'Attributes', font = ('tr 15 bold'), command = lambda:searching('atrribute'))
        ...
        self.button = Button(self.left, text = 'Register Player', font = ('tr 15 bold'), command = lambda: rg())

        self.button.place(x = 230, y = 600)

        self.button2 = Button(self.left, text = 'Lookup Players', font = ('tr 15 bold'), command = lambda: lk())
